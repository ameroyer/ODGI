...
#SBATCH -o ./log/output_logs/standard-vedai.%N.%j.out     # logfile for stdout
#SBATCH -e ./log/error_logs/standard-vedai.%N.%j.err # logfile for stderr
...
python3 -u train_standard.py $DATA --size $SIZE --num_epochs=$NUM_EPOCHS --num_gpus=$NUM_GPUS --display_loss_very_n_steps=$DISPLAY_LOSS_EVERY_N_STEPS --batch_size=$BATCH_SIZE