...
#          Decoding Functions           #
#                                       #
#  Applies one last 1x1 conv layer and  #
#  formats the output to return the     #
#  predicted boxes' coordinates, scales #
#  group flags, offsets etc.            #
#########################################
...
def get_detection_outputs(activations,
    ...
    Args:
        ...
        is_training: In particular, indicates wether to return optional outputs,
            only needed for training: confidence_scores, shifted_centers, log_scales
    ...
    with tf.name_scope('fc_out'):
        ...
        out = tf.layers.conv2d(activations,
                               ...
                               padding='valid',
                               activation=None,
                               kernel_initializer=tf.truncated_normal_initializer(stddev=stddev_init),
                               name='fc_out')
...
def get_detection_outputs_with_groups(activations,
                                      ...
                                      verbose=False,
                                      **kwargs):
    """ Detection with groups (intermediate stage).
...
#                 BACKBONES                 #
#                                           #
#  Each backbone function takes as input    #
#  a batch of images (4D Tensor), and a     #
#  set of keyword arguments. It then        #
#  outputs a 4D Tensor representing the     #
#  before-to-last feature map which will    #
#  then be fed to the get_detection_outputs #
#  functions.                               #
#############################################
...
"""
    MobileNet
    Based on Tensorflow/slim implementation
"""
