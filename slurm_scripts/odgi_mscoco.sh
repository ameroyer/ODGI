...
#SBATCH --job-name=mscoco_odgi_${NETWORK}_${SIZE}_${STAGE2_IMAGE_SIZE}
#SBATCH -o ./run_logs/output_logs/mscoco_odgi_${NETWORK}_${SIZE}_${STAGE2_IMAGE_SIZE}.%j.out     # logfile for stdout
#SBATCH -e ./run_logs/error_logs/mscoco_odgi_${NETWORK}_${SIZE}_${STAGE2_IMAGE_SIZE}.%j.err      # logfile for stderr
