...
#SBATCH --job-name=mscoco_${NETWORK}_${SIZE}
#SBATCH -o ./run_logs/output_logs/mscoco_${NETWORK}_${SIZE}.%j.out     # logfile for stdout
#SBATCH -e ./run_logs/error_logs/mscoco_${NETWORK}_${SIZE}.%j.err      # logfile for stderr
...
python3 -u train_standard.py 'mscoco' --network $NETWORK --image_size $SIZE --num_epochs $NUM_EPOCHS --num_gpus $NUM_GPUS --batch_size $BATCH_SIZE --learning_rate $LEARNING_RATE
EOT