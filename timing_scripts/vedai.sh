...
for i in $(seq 1 10); 
do 
    python3 time_model.py --test_num_crops $i --test_patch_nms_threshold 0.25 --test_patch_confidence_threshold 0.1 --test_patch_strong_confidence_threshold 0.9 ./log/vedai_fold01/tiny-yolov2_odgi_256_64/09-23_10-49
done
...
for i in $(seq 1 10); 
do 
    python3 time_model.py --test_num_crops $i --test_patch_nms_threshold 0.25 --test_patch_confidence_threshold 0.1 --test_patch_strong_confidence_threshold 0.9 ./log/vedai_fold01/tiny-yolov2_odgi_128_64/09-27_10-44
done
...
echo '============================================================== STANDARD 256'
python3 time_model.py ./log/vedai_fold01/tiny-yolov2_standard_256/09-26_12-46/

echo '============================================================== STANDARD 128'
python3 time_model.py ./log/vedai_fold01/tiny-yolov2_standard_128/09-26_18-24/
